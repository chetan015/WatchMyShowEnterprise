...
@NamedQueries({
    ...
    , @NamedQuery(name = "Content.findByGenre", query = "SELECT c FROM Content c WHERE c.genre = :genre")
    , @NamedQuery(name = "Content.findByType", query = "SELECT c FROM Content c WHERE c.type = :type")
    , @NamedQuery(name = "Content.findByRating", query = "SELECT c FROM Content c WHERE c.rating = :rating")})
